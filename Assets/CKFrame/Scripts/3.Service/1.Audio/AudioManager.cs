...
namespace CKFrame
{
    public class AudioManager : ManagerBase<AudioManager>
    {
        ...
        [SerializeField] [OnValueChanged("UpdataMute")]
        ...
        [SerializeField] [OnValueChanged("UpdataLoop")]
        ...
        private IEnumerator DoRecycleAudioPlay(AudioSource audioSource, AudioClip clip, UnityAction callback,
            float time)
        {
            // 延迟Clip的长度（秒）
        ...
        public void PlayOnShot(AudioClip clip, Component component, float volumeScale = 1, bool is3d = true,
        ...
        /// <param name="callback">回调函数-在音乐播放完成后执行</param>
        /// <param name="callBackTime">回调函数-在音乐播放完成后执行的延迟时间</param>
        public void PlayOnShot(AudioClip clip, Vector3 postion, float volumeScale = 1, bool is3d = true,
            UnityAction callback = null, float callBackTime = 0)
        {
            // 初始化音乐播放器
            AudioSource audioSource = GetAudioPlay(is3d);
        ...
        /// <param name="callback">回调函数-在音乐播放完成后执行</param>
        /// <param name="callBackTime">回调函数-在音乐播放完成后执行的延迟时间</param>
        public void PlayOnShot(string clipPath, Vector3 postion, float volumeScale = 1, bool is3d = true,
            UnityAction callback = null, float callBackTime = 0)
        {
            AudioClip audioClip = ResManager.LoadAsset<AudioClip>(clipPath);
