...
public static class CKEventListenerExtend
{
    #region 工具函数
    private static CKEventListener GetOrAddEventListener(Component com)
    {
        CKEventListener lis = com.GetComponent<CKEventListener>();
        if (lis == null) return com.gameObject.AddComponent<CKEventListener>();
        else return lis;
    }
    public static void AddEventListener<T>(this Component com, CKEventType eventType, Action<T, object[]> action,
        params object[] args)
    {
        CKEventListener lis = GetOrAddEventListener(com);
        lis.AddListener(eventType, action, args);
    }

    public static void RemoveEventListener<T>(this Component com, CKEventType eventType, Action<T, object[]> action,
    ...
    public static void RemoveAllListener(this Component com,CKEventType eventType)
    {
        CKEventListener lis = GetOrAddEventListener(com);
    ...
    {
        RemoveEventListener(com, CKEventType.OnClick, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnClickDown, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnClickUp, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnDrag, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnBeginDrag, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnEndDrag, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnCollisionEnter, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnCollisionStay, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnCollisionExit, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnCollisionEnter2D, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnCollisionStay2D, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnCollisionExit2D, action, checkArgs, args);
    }
    #endregion
    ...
    {
        AddEventListener(com, CKEventType.OnTriggerEnter, action, checkArgs, args);
    }
    ...
    {
        AddEventListener(com, CKEventType.OnTriggerStay, action, checkArgs, args);
    }
    ...
    {
        AddEventListener(com, CKEventType.OnTriggerExit, action, checkArgs, args);
    }
    ...
    {
        AddEventListener(com, CKEventType.OnTriggerEnter2D, action, checkArgs, args);
    }
    ...
    {
        AddEventListener(com, CKEventType.OnTriggerStay2D, action, checkArgs, args);
    }
    ...
    {
        AddEventListener(com, CKEventType.OnTriggerExit2D, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnTriggerEnter, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnTriggerStay, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnTriggerExit, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnTriggerEnter2D, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnTriggerStay2D, action, checkArgs, args);
    }
    ...
    {
        RemoveEventListener(com, CKEventType.OnTriggerExit2D, action, checkArgs, args);
    }
    #endregion
